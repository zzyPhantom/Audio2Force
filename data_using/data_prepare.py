...
file_num = 4  # 文件编号
audio_params = {
    1: {"startTime": 8, "endTime": 410, "init_force": 0.5},
    2: {"startTime": 7, "endTime": 40, "init_force": 0},
    3: {"startTime": 1, "endTime": 310, "init_force": 0.15},
    4: {"startTime": 1, "endTime": 205, "init_force": 0.3},
}
...
# 获取时间参数
startTime = audio_params[file_num]["startTime"]
endTime = audio_params[file_num]["endTime"]
init_force = audio_params[file_num]["init_force"]

# 读录制的文件
fs, data = wav.read(f"/home/zzy/Projects/Battery_sanding/data_using/audio_{file_num}.wav")
...
plot_peak_vals = np.vstack(top_freqs)
...
filename = f"/home/zzy/Projects/Battery_sanding/data_using/force_pos_{file_num}.pkl"
...
save_path = f"/home/zzy/Projects/Battery_sanding/data_using/train_data_{file_num}.npz"
np.savez(save_path, x=input_features, y=aligned_forces)
